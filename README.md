...
- [as_end2end.py](as_end2end.py): from natural language to argumentation semantics; related files are [nl2apx.py](nl2apx.py), [af_clingo.py](af_clingo.py) and the alternative bare-bones solver [apxsolve.py](apxsolve.py).
